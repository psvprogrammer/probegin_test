"""
Django settings for probegin_test project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '*3&f0579@d)w(t&csf(8+z31&_1*tt=+v47c7^u8r7^@w&akl3')
...
ROOT_URLCONF = 'probegin_test.urls'
...
WSGI_APPLICATION = 'probegin_test.wsgi.application'
